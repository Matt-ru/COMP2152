...
while True:
    try:
        ...
        if combatStrength in diceOptions:
            break
        else:
...
while True:
    try:
        ...
        if mCombatStrength in diceOptions:
            break
        else:
    ...
    for j in range(1, 20, 2):
        ...
        selected_weapon = weapons[hero_roll - 1]

        print(f"\nRound {j}:")
        print(f" Hero rolls {hero_roll}, Monster rolls {monster_roll}")
        print(f" Hero strength: {hero_strength}, Monster strength: {monster_strength}")
        print(f" Hero uses {selected_weapon}")
